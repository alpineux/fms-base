...
export default function Footer() {
  return (
    <footer className="mx-auto max-w-[1920px] px-6">
      {/*<div className="grid grid-cols-1 gap-8 py-12 text-black transition-colors duration-150 border-b lg:grid-cols-12 border-zinc-600">
        ...
        <div className="col-span-1 lg:col-span-2">
          <ul className="flex flex-col flex-initial md:flex-1">
            <li className="py-3 md:py-0 md:pb-4">
              <Link
                href="/"
                className="text-black transition duration-150 ease-in-out hover:text-zinc-500"
              >
                Home
              </Link>
            </li>
      ...
      <div className="flex flex-col items-center justify-between py-12 space-y-4 md:flex-row">
        <div>
          <span>
            &copy; {new Date().getFullYear()} My App, Inc. All rights reserved.
          </span>
        </div>
      </div>
    </footer>
